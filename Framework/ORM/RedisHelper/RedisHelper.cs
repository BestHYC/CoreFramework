...
namespace Framework
{
    ...
    public class RedisHelper
    {
        ...
        public static void Initial(RedisConfig config)
        {
        ...
        /// <param name="keyValuePairs"></param>
        /// <returns></returns>
        public static async Task<bool> StringSetAsync(IEnumerable<KeyValuePair<RedisKey, RedisValue>> keyValuePairs)
        {
            keyValuePairs =
                keyValuePairs.Select(x => new KeyValuePair<RedisKey, RedisValue>(AddKeyPrefix(x.Key), x.Value));
        ...
        /// <param name="expiry"></param>
        /// <returns></returns>
        public static async Task<string> StringGetAsync(string redisKey, string redisValue, TimeSpan? expiry = null)
        {
            redisKey = AddKeyPrefix(redisKey);
        ...
        public static async Task<long> StringIncrementAsync(string redisKey, long value = 1)
        {
            redisKey = AddKeyPrefix(redisKey);
            return await _db.StringIncrementAsync(redisKey, value);
        }
        public static async Task<long> StringDecrementAsync(string redisKey, long value = 1)
        {
            redisKey = AddKeyPrefix(redisKey);
            return await _db.StringDecrementAsync(redisKey, value);
        }
        public static long StringIncrement(string redisKey, long value = 1)
        {
            redisKey = AddKeyPrefix(redisKey);
            return _db.StringIncrement(redisKey, value);
        }
        public static long StringDecrement(string redisKey, long value = 1)
        {
            redisKey = AddKeyPrefix(redisKey);
            return _db.StringDecrement(redisKey, value);
        }
        #endregion async
        ...
        /// <returns></returns>
        public static async Task<long> HashIncrementAsync(string redisKey, RedisValue hashField, long value = 1)
        {
            redisKey = AddKeyPrefix(redisKey);
            return await _db.HashIncrementAsync(redisKey, hashField, value);
        }
        public static async Task<long> HashDecrementAsync(string redisKey, RedisValue hashField, long value = 1)
        {
            redisKey = AddKeyPrefix(redisKey);
            return await _db.HashDecrementAsync(redisKey, hashField, value);
        }
        public static long HashIncrement(string redisKey, RedisValue hashField, long value = 1)
        {
            redisKey = AddKeyPrefix(redisKey);
            return _db.HashIncrement(redisKey, hashField, value);
        }
        public static long HashDecrement(string redisKey, RedisValue hashField, long value = 1)
        {
            redisKey = AddKeyPrefix(redisKey);
            return _db.HashDecrement(redisKey, hashField, value);
        }
        /// <summary>
        /// 判断该字段是否存在 hash 中
        /// </summary>
        ...
        /// <param name="redisKey"></param>
        /// <returns></returns>
        public static async Task<IEnumerable<RedisValue>> ListRangeAsync(string redisKey)
        {
            redisKey = AddKeyPrefix(redisKey);
        ...
        /// <param name="redisKey"></param>
        /// <returns></returns>
        public static IEnumerable<RedisValue> SortedSetRangeByRank(string redisKey)
        {
            redisKey = AddKeyPrefix(redisKey);
        ...
        /// <param name="redisKey"></param>
        /// <returns></returns>
        public static async Task<IEnumerable<RedisValue>> SortedSetRangeByRankAsync(string redisKey)
        {
            redisKey = AddKeyPrefix(redisKey);
